...
h1, h2, h3, h4, h5{ color: rgb(51, 51, 51); font-family: proxima-nova-condensed, 'Arial Narrow', sans-serif; margin-top: 1em; margin-right: 0px; margin-bottom: 0.5em; margin-left: 0px; letter-spacing: 1px; line-height: 1.2; font-weight: 600; text-rendering: optimizelegibility; }
...
.footer .social-icon{ font-family: iconies_socialregular; }
 .footer h4, .footer h5{ color: rgb(238, 238, 238); font-size: 0.9375rem; text-transform: uppercase; }
@media only screen and (min-width: 40.0625em){
 .footer h4, .footer h5{ font-size: 0.875rem; }
}
...
@media screen and (min-width: 768px){
.nav-main a{ font-size: 0.93333rem; padding-top: 0.18em; padding-right: 0.75em; padding-bottom: 0.55em; padding-left: 0.75em; }
}
@media screen and (min-width: 980px){
.nav-main a{ font-size: 1.06667rem; padding-top: 0.25em; padding-right: 1.3em; padding-bottom: 0.55em; padding-left: 1.3em; }
}
@media screen and (min-width: 1140px){
.nav-main a{ font-size: 1.13333rem; padding-top: 0.25em; padding-right: 1.3em; padding-bottom: 0.55em; padding-left: 1.3em; }
}