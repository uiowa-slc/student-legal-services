...
@media screen and (min-width: 768px){
.nav-main a{ font-size: 0.93333rem; padding: 0.18em 0.75em 0.55em; }
}
@media screen and (min-width: 980px){
.nav-main a{ font-size: 1.06667rem; padding: 0.25em 1.3em 0.55em; }
}
@media screen and (min-width: 1140px){
.nav-main a{ font-size: 1.13333rem; padding: 0.25em 1.3em 0.55em; }
}